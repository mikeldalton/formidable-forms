	...
	public static function localize_script( $location ) {
		...
		if ( $location == 'admin' ) {
			...
			$admin_script_strings = array(
				...
				'reserved_param_danger'  => __( 'If you are passing the param in the URL, this can cause problems.  We recommend you change the param name unless you are an expert. ', 'formidable' ),
