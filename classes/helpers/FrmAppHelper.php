	...
	public static function localize_script( $location ) {
		...
		if ( $location == 'admin' ) {
			...
			$admin_script_strings = array(
				...
				'unsafe_params'     => FrmForm::list_of_unsafe_params(),
				'slug_is_reserved'   => __( 'Your Detail Page Slug is a reserved word, which can cause problems. We recommend you change your slug unless you are an expert.', 'formidable' ),
				'param_is_reserved'  => __( 'The name of your param is a reserved word.  If you are passing the param in the URL, this can cause problems.  We recommend you change the param name unless you are an expert. ', 'formidable' ),
