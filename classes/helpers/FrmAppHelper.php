	...
	public static function localize_script( $location ) {
		...
		if ( $location == 'admin' ) {
			...
			$admin_script_strings = array(
				...
				'slug_is_reserved'   => __( 'The Detail Page Slug selected is a reserved word.  This can cause real problems and should be avoided unless you are an expert. ', 'formidable' ),
				'param_is_reserved'  => __( 'The param you are using is a reserved word.  This can cause real problems and should be avoided unless you are an expert. ', 'formidable' ),
